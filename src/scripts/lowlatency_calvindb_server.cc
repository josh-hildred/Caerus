...
#include "sequencer/slog/lowlatency_sequencer.h"
...
int main(int argc, char** argv) {
  ...
  LowlatencySequencer * sequencer = new LowlatencySequencer(config, multiplexer, client, paxos, storage, FLAGS_max_batch_size);
